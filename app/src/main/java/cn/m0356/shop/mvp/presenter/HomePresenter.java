...
import cn.m0356.shop.mvp.model.HomeModel;
import cn.m0356.shop.mvp.model.IHomeModel;
...
public class HomePresenter extends BasePresenter<IHomeView> {
    ...
    public void attachView(IHomeView mvpView) {
        ...
        mainWidth = getMvpView().getMainActivity().getResources().getDimension(R.dimen.main_width);
    }

    /**
     * 显示首页轮播列表
     */
    public void showAdvList(JSONObject jsonObj, String objName, int height) throws IOException, JSONException {
        ArrayList<AdvertList> advertList = iHomeModel.analysisAdvList(jsonObj, objName);
        if (advertList != null && advertList.size() > 0) {
            initHeadImage(getMvpView().getAdvListView(), getMvpView().getDianView(), getMvpView().getDianViewList(), advertList, height);
        }
    }
    ...
    public void showAdvListLow(JSONObject jsonObj) throws IOException, JSONException {
        ...
        if (advertList != null && advertList.size() > 0) {
            initHeadImage(getMvpView().getAdvListLowView(), getMvpView().getDianLowView(), getMvpView().getDianViewLowList(), advertList, 280);
        }
    }

    // 展示广告列表的公用方法
    public void initHeadImage(ViewFlipper view, LinearLayout dian, ArrayList<ImageView> viewList,
                              ArrayList<AdvertList> list, int height) {
        LinearLayout.LayoutParams flipperParams = (LinearLayout.LayoutParams) view.getLayoutParams();
        flipperParams.width = (int) mainWidth;
        flipperParams.height = (int) (mainWidth / 640 * height);
        view.setLayoutParams(flipperParams);

        getMvpView().getHandler().removeMessages(HomeFragment.SHOW_NEXT);
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            ImageView imageView = new ImageView(getMvpView().getMainActivity());
            ...
            getMvpView().onImageViewClick(imageView, bean.getType(), bean.getData(), true);

            ImageView dianimageView = new ImageView(getMvpView().getMainActivity());
        ...
        view.setOnTouchListener(getMvpView().getAdvTouchListener());
        //myScrollView.setGestureDetector(mGestureDetector);

        if (viewList.size() > 1) {
            getMvpView().dianSelect();
            getMvpView().getHandler().sendEmptyMessageDelayed(HomeFragment.SHOW_NEXT, 3800);
        }
    }
    ...
    public void showGoods(JSONObject jsonObj) throws JSONException {
        ...
        if (!item.equals("[]")) {
            ...
            View goodsView = getMvpView().getMainActivity().getLayoutInflater().inflate(R.layout.tab_home_item_goods, null);
            ...
            HomeGoodsMyGridViewListAdapter adapter = new HomeGoodsMyGridViewListAdapter(getMvpView().getMainActivity());
            ...
            getMvpView().getHomeView().addView(goodsView);
        }
    }
    ...
    public void showPreferentialGoods(JSONObject jsonObj) throws IOException, JSONException {
        ...
        if (preGoodsLists != null && preGoodsLists.size() > 0) {
            View preGoodsView = getMvpView().getMainActivity().getLayoutInflater().inflate(R.layout.tab_home_item_pregoods, null);
            ...
            HomePreGoodsRecyclerAdapter adapter = new HomePreGoodsRecyclerAdapter(getMvpView().getMainActivity(), preGoodsLists);
            recyclerView.setAdapter(adapter);
            getMvpView().getHomeView().addView(preGoodsView);
        }
    }
    ...
    public void showNavigation(JSONObject jsonObj) throws IOException, JSONException {
        ...
        if (navLists != null && navLists.size() > 0) {
            View navigationView = getMvpView().getMainActivity().getLayoutInflater().inflate(R.layout.tab_home_item_nav, null);
            ...
            gridview.setFocusable(false);
            HomeNavMyGridViewListAdapter adapter = new HomeNavMyGridViewListAdapter(getMvpView().getMainActivity());
            ...
            getMvpView().getHomeView().addView(navigationView);
        }
    }
    ...
    public void showHome1(JSONObject jsonObj) throws JSONException {
        ...
        View home1View = getMvpView().getMainActivity().getLayoutInflater().inflate(R.layout.tab_home_item_home1, null);
        ...
        imageLoader.displayImage(bean.getImage(), imageView, options, animateFirstListener);
        getMvpView().onImageViewClick(imageView, bean.getType(), bean.getData(), false);
        getMvpView().getHomeView().addView(home1View);
    }
    ...
    public void showHome2(JSONObject jsonObj) throws JSONException {
        ...
        View home2View = getMvpView().getMainActivity().getLayoutInflater().inflate(R.layout.tab_home_item_home2_left, null);
        ...
        getMvpView().onImageViewClick(imageViewSquare, bean.getSquare_type(), bean.getSquare_data(), false);
        getMvpView().onImageViewClick(imageViewRectangle1, bean.getRectangle1_type(), bean.getRectangle1_data(), false);
        getMvpView().onImageViewClick(imageViewRectangle2, bean.getRectangle2_type(), bean.getRectangle2_data(), false);
        ...
        getMvpView().getHomeView().addView(home2View);
    }
    ...
    public void showHome4(JSONObject jsonObj) throws JSONException {
        ...
        Home2Data bean = Home2Data.newInstanceDetelis(home2Json);
        View home4View = getMvpView().getMainActivity().getLayoutInflater().inflate(R.layout.tab_home_item_home2_rehit, null);
        ...
        getMvpView().getHomeView().addView(home4View);
    }
    ...
    public void showHome5(JSONObject home5) throws JSONException {
        ...
        View home5View = getMvpView().getMainActivity().getLayoutInflater().inflate(R.layout.tab_home_item_home5, null);
        GridView gridview = (GridView) home5View.findViewById(R.id.index_home_gridview_my);
        gridview.setFocusable(false);
        gridview.setSelector(new ColorDrawable(Color.TRANSPARENT));
        GridViewAdapter adapter = new GridViewAdapter(getMvpView().getMainActivity());
        adapter.setHome5Datas(home5Datas);
        gridview.setAdapter(adapter);
        adapter.notifyDataSetChanged();
        getMvpView().getHomeView().addView(home5View);
    }
    ...
    public void showHome7(JSONObject jsonObj) throws IOException, JSONException {
        ...
        View home7View = getMvpView().getMainActivity().getLayoutInflater().inflate(R.layout.tab_home_item_home7, null);
        ...
        getMvpView().onImageViewClick(imageview1, bean1.getType(), bean1.getData(), false);
        getMvpView().onImageViewClick(imageview2, bean2.getType(), bean2.getData(), false);
        getMvpView().onImageViewClick(imageview3, bean3.getType(), bean3.getData(), false);
        getMvpView().onImageViewClick(imageview4, bean4.getType(), bean4.getData(), false);
        ...
        getMvpView().getHomeView().addView(home7View);
    }
    ...
    public void showHome8(JSONObject jsonObj) throws IOException, JSONException {
        ...
        View home8View = getMvpView().getMainActivity().getLayoutInflater().inflate(R.layout.tab_home_item_home8, null);
        ...
        getMvpView().getHomeView().addView(home8View);
    }
    ...
    public void showHome9(JSONObject jsonObj) throws IOException, JSONException {
        ...
        View home9View = getMvpView().getMainActivity().getLayoutInflater().inflate(R.layout.tab_home_item_home9, null);
    ...
    public void showHome11(JSONObject jsonObj) throws IOException, JSONException {
        ...
        View home11View = getMvpView().getMainActivity().getLayoutInflater().inflate(R.layout.tab_home_item_home11, null);
        ...
        getMvpView().getHomeView().addView(home11View);
    }
    ...
    public void showHome12(JSONObject jsonObj) throws IOException, JSONException {
        ...
        View home12View = getMvpView().getMainActivity().getLayoutInflater().inflate(R.layout.tab_home_item_home12, null);
        ...
        getMvpView().getHomeView().addView(home12View);
    }
    ...
    public void showHome13(JSONObject jsonObj) throws IOException, JSONException {
        ...
        View home13View = getMvpView().getMainActivity().getLayoutInflater().inflate(R.layout.tab_home_item_home13, null);
        ...
        for (int i = 0; i < home13Imgs.size(); i++) {
            ...
            getMvpView().onImageViewClick(home13Imgs.get(i), home13Data.get(i).getType(), home13Data.get(i).getData(), false);
        }
        ...
        getMvpView().getHomeView().addView(home13View);
    }
    ...
    public void showHome14(JSONObject jsonObj) throws IOException, JSONException {
        ...
        View home14View = getMvpView().getMainActivity().getLayoutInflater().inflate(R.layout.tab_home_item_home7, null);
        ...
        getMvpView().getHomeView().addView(home14View);
    }
    ...
    public void showHome15(JSONObject jsonObj) throws IOException, JSONException {
        ...
        View home15View = getMvpView().getMainActivity().getLayoutInflater().inflate(R.layout.tab_home_item_home1, null);
        ...
        imageLoader.displayImage(bean.getImage(), imageView, options, animateFirstListener);
        getMvpView().onImageViewClick(imageView, bean.getType(), bean.getData(), false);
        getMvpView().getHomeView().addView(home15View);
    }
