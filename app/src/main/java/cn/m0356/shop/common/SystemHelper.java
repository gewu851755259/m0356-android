...
public class SystemHelper {
     ...
     * @return
     */
    public static String obtainApkPath(String version) {
        return Constants.CACHE_DIR + "android_jcg_" + version + ".apk";
    }
     ...
     * @param version
     */
    public static void showNotify(Context context, String version) {
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
                .setSmallIcon(R.drawable.ic_launcher)
                .setSmallIcon(R.drawable.ic_launcher)
                .setContentTitle("提示")
                .setContentText("新版本已在WIFI环境下载完成，点击安装")
                .setAutoCancel(true);
        int flags = PendingIntent.FLAG_UPDATE_CURRENT;
        Intent i = new Intent(Intent.ACTION_VIEW);
        File file = new File(SystemHelper.obtainApkPath(version));
        if (!file.exists())
            return;
        i.setDataAndType(Uri.parse("file://" + SystemHelper.obtainApkPath(version)),
                "application/vnd.android.package-archive");
        PendingIntent pi = PendingIntent.getActivity(context, 0, i, flags);
