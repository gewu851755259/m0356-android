...
import cn.m0356.shop.bean.StoreIntroduce;
import cn.m0356.shop.bean.StoreVoucher;
import cn.m0356.shop.common.Constants;
import cn.m0356.shop.common.JsonFastUtil;
...
import cn.m0356.shop.custom.NCNewStoreVoucherPopupWindow;
...
//        initFragment();
    ...
    protected void onResume() {
        ...
        StatService.onPageStart(this, "店铺界面");
    }

    @Override
    protected void onPause() {
        super.onPause();
        StatService.onPageEnd(this, "店铺界面");
    }
}
