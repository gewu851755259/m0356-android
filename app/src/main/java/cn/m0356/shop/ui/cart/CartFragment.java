...
public class CartFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        llLogin = (RelativeLayout) layout.findViewById(R.id.llLogin);
    ...
    public void onResume() {
        super.onResume();
        loadCartData();
        StatService.onPageStart(MyShopApplication.context, "主界面-购物车");
    }

    @Override
    public void onPause() {
        super.onPause();
        StatService.onPageEnd(MyShopApplication.context, "主界面-购物车");
    }
