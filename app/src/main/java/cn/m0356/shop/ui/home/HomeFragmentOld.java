 ...
 * @Time 2015-8-17
 */
public class HomeFragmentOld extends Fragment implements OnGestureListener, OnTouchListener {
   ...
   /* private void getNoticeList() {
    ...
    public void initHeadImage(ArrayList<AdvertList> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            ImageView imageView = new ImageView(HomeFragmentOld.this.getActivity());
            ...
            ImageView dianimageView = new ImageView(HomeFragmentOld.this.getActivity());
