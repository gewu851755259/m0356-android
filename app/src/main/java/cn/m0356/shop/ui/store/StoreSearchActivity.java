...
import cn.m0356.shop.adapter.StoreClassifyAdapter;
import cn.m0356.shop.bean.StoreGoodsClassList;
import cn.m0356.shop.common.Constants;
import cn.m0356.shop.common.DateConvert;
...
public class StoreSearchActivity extends Activity implements OnClickListener{
	...
	protected void onResume() {
		super.onResume();
		StatService.onPageStart(this, "店铺搜索界面");
	}

	@Override
	protected void onPause() {
		super.onPause();
		StatService.onPageEnd(this, "店铺搜索界面");
	}
