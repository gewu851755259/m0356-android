...
public class ScrollViewContainer extends RelativeLayout {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        bottomView.layout(0, topView.getMeasuredHeight() + (int) mMoveLen + ScreenUtil.dip2px(45),
    ...
    private void smoothScrollTo(int destX, int destY) {
        ...
        mScroller.startScroll(scrollY, 0, deltaY, 0, 1000);
        invalidate();
    }
    ...
    public void setOnScrollToTopListener(OnScrollToTopListener onScrollToTopListener) {
        mOnScrollToTopListener = onScrollToTopListener;
    }
    ...
    public void scrollTop() {
        this.mMoveLen = getScrollY();
        mTimer.schedule(2);
        ((ScrollView) bottomView).smoothScrollTo(0, 0);
        ((ScrollView) topView).smoothScrollTo(0, 0);
        canPullUp = false;
        mCurrentViewIndex = 0;
...
//        ((ScrollView)bottomView).smoothScrollTo(0, 0);
        ...
        /*ScrollView sv = (ScrollView)bottomView;
        sv.smoothScrollTo(0, 0);
        sv.clearFocus();
        if(topView.requestFocus()){
            ((ScrollView)topView).smoothScrollTo(0, 0);
            Toast.makeText(MyShopApplication.context, "top request focus", Toast.LENGTH_SHORT).show();
        }*/
