...
public class BuyStep1 {
	...
	public BuyStep1(String store_cart_list, String freight_hash,
			...
			String inv_info, String available_predeposit,String available_rc_balance,String rpt_list,String ziti) {
		super();
	...
	public static BuyStep1 newInstanceList(String json){
		...
		try {
			...
			if(obj.length()> 0){
				...
				String ziti = obj.optString(Attr.ZITI);
				 bean = new BuyStep1(store_cart_list, freight_hash, address_info, ifshow_offpay,
						 vat_hash, inv_info, available_predeposit,available_rc_balance,rpt_list,ziti);
			}
