...
public class OrderList {
	...
	public OrderList(String order_id, String order_sn, String order_state,
					 ...
					 String evaluation_again_state, String evaluation_state) {
		super();
	...
	public static ArrayList<OrderList> newInstanceList(String jsonDatas) {
		...
		try {
			...
			for (int i = 0; i < size; i++) {
				...
				// 20160817
				String evaluation_again_state = obj.optString(Attr.EVALUATION_AGAIN_STATE);
				String evaluation_state = obj.optString(Attr.EVALUATION_STATE);
				AdvertDatas.add(new OrderList(order_id, order_sn, order_state, store_name, state_desc, order_amount, extend_order_goods,
						payment_name, shipping_fee, if_cancel, if_receive, if_lock, if_deliver, zengpin_list, if_evaluation, if_evaluation_again, if_refund_cancel, refund_list,
						refund_state, evaluation_again_state, evaluation_state
				));
			}
	...
	public String toString() {
		return "OrderList{" +
				...
				", zengpin_list='" + zengpin_list + '\'' +
				", if_evaluation='" + if_evaluation + '\'' +
				", if_evaluation_again='" + if_evaluation_again + '\'' +
				", if_refund_cancel='" + if_refund_cancel + '\'' +
				", refund_list='" + refund_list + '\'' +
				", refund_state='" + refund_state + '\'' +
				", evaluation_again_state='" + evaluation_again_state + '\'' +
