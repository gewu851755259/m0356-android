...
public class HomeGoodsList {
    ...
    public HomeGoodsList(String goods_id, String goods_name, String goods_price,
    ...
    public static ArrayList<HomeGoodsList> newInstanceList(String jsonDatas) {
        ...
        try {
            ...
            for (int i = 0; i < size; i++) {
                ...
                String goods_price = "";
                if (obj.has(Attr.GOODS_PRICE))
                    goods_price = obj.optString(Attr.GOODS_PRICE);
                String goods_promotion_price = obj.optString(Attr.GOODS_PROMOTION_PRICE);
                String goods_image = obj.optString(Attr.GOODS_IMAGE);
                AdvertDatas.add(new HomeGoodsList(goods_id, goods_name, goods_price, goods_promotion_price, goods_image));
            }
